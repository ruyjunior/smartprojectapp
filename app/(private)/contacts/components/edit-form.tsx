...
import { formatCPF, formatCEP, formatPhone, formatDateDb } from '@/app/utils/utils';
import Link from 'next/link';
import { Button } from '@/app/ui/button';
import { updateContact, State } from '@/app/query/contacts/actions';
...
export default function EditContactForm({
  ...
  const [cep, setCEP] = useState(formatCEP(contact.cep));
  const [cpf, setCPF] = useState(formatCPF(contact.cpf));

  if (!contact.birth) {
    contact.birth = '';
  }
  const birth = formatDateDb(contact.birth);
